...
module.exports.registerUser2 = async function main() {
    try {
        // load the network configuration
        ...
        if (!adminIdentity) {
            console.log('An identity for the admin user "admin" does not exist in the wallet');
            //console.log('Run the enrollAdmin.js application before retrying');
            adminIdentity= await enrollAdmin.enrollAdmin2();
        }
...
module.exports.registerUserGeneral = async function (res) {
    try {
        var userid = getRandomInt(10000000).toString();
        // load the network configuration
        const ccpPath = path.resolve(__dirname, '..','..','..', 'organizations', 'peerOrganizations', 'org1.example.com', 'connection-org1.json');
        const ccp = JSON.parse(fs.readFileSync(ccpPath, 'utf8'));
...
module.exports.registerUserGeneral2 = async function (res) {
    try {
        // load the network configuration
        var userid = getRandomInt(10000000).toString();
